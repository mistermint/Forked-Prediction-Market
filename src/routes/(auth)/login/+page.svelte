...
<div class="card space-y-6">
	<div>
		<h1 class="font-pixel text-pixel-sm text-text-primary">WELCOME BACK</h1>
		<p class="text-text-muted text-xs font-mono mt-1">Log in to your account</p>
	</div>

	{#if authError}
		<p class="text-accent-red text-xs font-mono bg-accent-red/10 border border-accent-red/30 rounded-retro px-3 py-2">
